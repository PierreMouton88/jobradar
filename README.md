...
- récupérer des offres depuis des sources contrôlées, des exports externes et des actors Apify ;
...
│  │
│  ├─ imports/
│  │  └─ import-external-job-offers-to-db.ts
│  │
│  ├─ offers/
│  │  ├─ get-offers.ts
...
APIFY_TOKEN
→ token Apify utilisé côté serveur/local pour lire des datasets ou lancer des actors
...
Les premières sources étaient fictives ou locales. La V2 ajoute maintenant des exports externes et des actors Apify contrôlés.
